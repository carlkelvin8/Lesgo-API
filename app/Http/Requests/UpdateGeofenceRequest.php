...
class UpdateGeofenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'sometimes|in:delivery_zone,service_area,restricted_area,pickup_zone,partner_location',
            'shape' => 'sometimes|in:circle,polygon',
            ...
            'trigger_on_enter' => 'sometimes|boolean',
            'trigger_on_exit' => 'sometimes|boolean',
            'trigger_on_dwell' => 'sometimes|boolean',
